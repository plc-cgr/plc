...
<div id="register_form">
    ...
    <p><fmt:message key="register.setup" />:</p>
    <s:form cssClass="form-stacked" id="registerForm" name="register" namespace="/www/wizard" action="register" method="post">
        <fieldset>
            ...
            <div class="clearfix">
                <label for="repeatPassword"><fmt:message key="register.repeatPassword" /></label>
                <div class="input">
            ...
            <div class="clearfix">
                <label for="repeatEmail"><fmt:message key="register.repeatEmail" /></label>
                <div class="input">
            ...
            <div class="clearfix">
                <label for="challengeQuestion"><fmt:message key="register.challengeQuestion" /></label>
                <div class="input">
            ...
            <div class="clearfix">
                <label for="challengeAnswer"><fmt:message key="register.challengeAnswer" /></label>
                <div class="input">
